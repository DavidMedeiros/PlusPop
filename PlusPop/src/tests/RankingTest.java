...
public class RankingTest {
	...
	public void setUp() {
		try {
			...
			systemPop.cadastraUsuario("David", "sdavidmedeiros@gmail.com",
					"david951", "16/12/1995");
			systemPop.cadastraUsuario("Jonas", "jonasgomes@gmail.com",
					"jonas123", "20/10/1993");
			systemPop.cadastraUsuario("Ana", "anabarros@gmail.com",
					"aninha123", "01/04/1993");
			systemPop.cadastraUsuario("Gabi", "gabimotta@gmail.com", "gabi123",
					"18/01/1996");
	...
	public void RankingSistemaTest() {
		try {
			...
			systemPop.criaPost(
					"Sonoooo #BomDia #QueroFerias #Trabalhando #LP2",
					"03/11/2015 21:22:12");
			...
			// CRIA POSTS CORRETAMENTE
			systemPop.criaPost("Estudando! Prova amanha! #LP2",
					"03/11/2015 13:15:05");
